...
class _$WeatherResponseCopyWithImpl<$Res>
  ...
  @pragma('vm:prefer-inline')
  $CurrentWeatherUnitsCopyWith<$Res> get currentWeatherUnits {
    return $CurrentWeatherUnitsCopyWith<$Res>(_self.currentWeatherUnits,
        (value) {
...
extension WeatherResponsePatterns on WeatherResponse {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_WeatherResponse value)? $default, {
    ...
    switch (_that) {
      case _WeatherResponse() when $default != null:
        return $default(
            ...
            _that.utcOffsetSeconds,
            _that.timezone,
            _that.timezoneAbbreviation,
            _that.elevation,
            _that.currentWeatherUnits,
...
class _WeatherResponse implements WeatherResponse {
  const _WeatherResponse(
      ...
      @JsonKey(name: 'current_weather_units') required this.currentWeatherUnits,
...
mixin _$CurrentWeatherUnits {
  ...
  $CurrentWeatherUnitsCopyWith<CurrentWeatherUnits> get copyWith =>
      _$CurrentWeatherUnitsCopyWithImpl<CurrentWeatherUnits>(
          this as CurrentWeatherUnits, _$identity);
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, time, interval, temperature,
...
abstract mixin class $CurrentWeatherUnitsCopyWith<$Res> {
  factory $CurrentWeatherUnitsCopyWith(
          CurrentWeatherUnits value, $Res Function(CurrentWeatherUnits) _then) =
      _$CurrentWeatherUnitsCopyWithImpl;
  @useResult
  $Res call(
      {String time,
      String interval,
...
extension CurrentWeatherUnitsPatterns on CurrentWeatherUnits {
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_CurrentWeatherUnits value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
...
class _CurrentWeatherUnits implements CurrentWeatherUnits {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$CurrentWeatherUnitsCopyWith<_CurrentWeatherUnits> get copyWith =>
      __$CurrentWeatherUnitsCopyWithImpl<_CurrentWeatherUnits>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$CurrentWeatherUnitsToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$CurrentWeatherUnitsCopyWith<$Res>
    implements $CurrentWeatherUnitsCopyWith<$Res> {
  factory _$CurrentWeatherUnitsCopyWith(_CurrentWeatherUnits value,
          $Res Function(_CurrentWeatherUnits) _then) =
      __$CurrentWeatherUnitsCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String time,
...
extension HourlyUnitsPatterns on HourlyUnits {
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_HourlyUnits value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _HourlyUnits() when $default != null:
        return $default(_that.time, _that.temperature2m);
      case _:
        return orElse();
    }
  }
...
extension HourlyPatterns on Hourly {
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_Hourly value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
  ...
  @optionalTypeArgs
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(List<String> time,
            @JsonKey(name: 'temperature_2m') List<double> temperature2m)?
        $default, {
    required TResult orElse(),
  }) {
